...
class DatabaseManager:
    ...
    def init_database(self):
        with sqlite3.connect(self.db_path) as conn:
            ...
            cursor.execute('CREATE INDEX IF NOT EXISTS idx_driver_id ON locations (driver_id)')
    ...
    def register_driver(self, driver_id: str, telegram_user_id: int, username: str) -> bool:
        try:
            with sqlite3.connect(self.db_path) as conn:
                cursor = conn.cursor()
                cursor.execute('''
